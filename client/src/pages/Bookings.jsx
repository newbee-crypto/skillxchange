    ...
    <div className="space-y-6 fade-in">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button
          ...
          className="w-full sm:w-auto px-4 py-2.5 bg-primary-600 text-white rounded-xl hover:bg-primary-500 transition-colors flex items-center justify-center gap-2 font-medium"
        >
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {bookings.map((b) => {
            ...
            return (
              <div key={b._id} className="glass rounded-xl p-4 sm:p-5 glass-hover transition-all">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                  <div className="flex min-w-0 items-start gap-4">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-2 flex flex-wrap items-center gap-3 text-sm text-dark-100">
